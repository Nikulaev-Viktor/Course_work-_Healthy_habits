    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_nick', models.CharField(blank=True, help_text='Укажите свой ник', max_length=50, null=True, verbose_name='TG ник')),
                ('tg_chat_id', models.CharField(blank=True, help_text='Укажите ID чата', max_length=50, null=True, verbose_name='ID чата')),
